...
4. **Scroll-Spy** — bisher bewusst ausgelassen. Beide Sync-Richtungen (Sektion + Baustein) sind klick-basiert. Scroll-Spy würde die aktive Sektion/den aktiven Baustein automatisch hervorheben, während man die Vorschau scrollt — braucht einen IntersectionObserver im Iframe, der Treffer per postMessage zurückmeldet (im Iframe fragil, daher aufgeschoben).
